...
**CLI**: [googleworkspace/cli](https://github.com/googleworkspace/cli)。インストール・認証の正本は **gws-params-encoding** の [references/official-googleworkspace-cli.md](../gws-params-encoding/references/official-googleworkspace-cli.md)。
...
| **gws-sheets** | スプレッドシート（読取・新規・メタ・更新） |
...
- **gws** がインストールされ、PATH にあること。Node から `spawn` する場合は **gws-params-encoding** の [references/node-resolve-gws.md](../gws-params-encoding/references/node-resolve-gws.md)（`GWS_PATH`・Windows の `cmd /c`）を参照。
